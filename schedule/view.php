        ...
        <?php if (isset($_GET['direction']) && isset($_GET['lane'])) : ?>
            <div class="mt-8 w-[90%] flex flex-col justify-start items-center space-y-4">
                <div class="flex flex-row items-center justify-center w-full space-x-24 text-lg">
                    ...
                    <a href="./users/new.php" class="flex items-center justify-between px-3 py-1 font-semibold border border-2 rounded-lg w-fit hover:bg-emerald-500 text-emerald-500 hover:text-white hover:stroke-white stroke-emerald-500 border-emerald-500">
